	...
	?>
				<form id="form_registo" name="form_registo" method="POST" action="processarRegistoLivro.php">
					...
					<div>
						...
						<span><input type="text" class="textbox" name="livroNome" placeholder="Insira o nome do material"></span>
					</div>
					<div>
						<span><label>Descrição:</label></span>
						<span><input type="text" class="textbox" name="autorNome" placeholder="Descrição do material"></span>
					</div>
					<div>
					...
					<div>
						...
						<span><input type="text" class="short" name="exemplarNrs" placeholder="Insira a quantidade"></span>
					</div>
					<div class="clear"></div>
