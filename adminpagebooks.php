    ...
    <div class="content">
    	<div class="section group">
			...
			<div class="col span_2_of_3">
				...
				<div class="clear"></div>
				<div class="gridtable">
					<p>Registo individual de produtos existentes no catálogo de material.</p>
					<table><tr><th>id</th><th>Designação/Descrição/Categoria</th><th colspan="4">operações</th></tr>
...
<?php
	...
	if(!empty(mysqli_num_rows($resultado))){
		...
		while($linha = mysqli_fetch_array($resultado)){
			...
			echo "<td><span><a href='adminpagebookscover.php?id=".$id."&mode=cover'><img src='images/picture.png' alt='capa'> imagem</span></td>";
		}
		echo "</table><br>";
