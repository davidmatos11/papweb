...
<body>
	...
	<div class="header">
		...
		<div class="header_top">
			<div class="logo">
			  ...
			  <div class="cart">
			  	   <p><span><img src="images/shopping-cart.png" alt="Carrinho"></span>
				   <?php 
				   	//abrir ligação à bd
					...
					?>
						<div id="dd" class="wrapper-dropdown-2"><?php echo $itens ?> Produto(s)
							<ul class="dropdown">
								<li><?php echo $msg ?></li>
						</ul>
						</div>
 ...
 <div class="main">
   ...
   <div class="section group">
	<?php
		//procurar 4 produtos aleatoriamente para exibir aqui
				       ...
				       <div class="price-number">
					    ...
					    <div class="add-cart">								
								<h4><?php echo "<a href='preview.php?id=".$id."'>"; ?>
									<img src="images/shopping-cart.png" alt="Carrinho"></a></h4>
						</div>
						<div class="clear"></div>
					</div>
				</div>
...
?>
   ...
   <div class="footer">	
	     <div class="section group">
				<div class="col_1_of_4 span_1_of_5">
						<h4>Information</h4>
						<ul>
				...
				<div class="col_1_of_4 span_1_of_4">
					<h4>Contacto</h4>
						<ul>
							<li><span><img src="images/location.png"> Estrada da Freiria 2440-062 Batalha</span></li>
