<?php
	...
	if (!empty($_POST) AND ( empty($_POST['livroNome']) OR empty($_POST['autorNome']) OR empty($_POST['categoriaId'])  OR empty($_POST['origemId']) OR empty($_POST['exemplarNrs'])) ) {
    ...
    elseif (isset($_POST['save'])) {
		$consulta = "INSERT INTO livros (idCat, titulo, autor, idOrigem, exemplares) VALUES ('$categoria','$titulo2','$autor2','$origem','$exemplares')";
